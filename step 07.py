...
pygame.display.set_caption("Snake game step07")
...
def game_over():
    ...
    global s, snack # 뱀과 먹이를 초기화를 위해 global 사용

    win.fill((0,0,0))
    game_over_text = FONT.render(f"GameOver! Score:{len(s.body)-1}", True, (255,255,255))
